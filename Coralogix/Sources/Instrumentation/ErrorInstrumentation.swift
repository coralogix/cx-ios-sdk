...
extension CoralogixRum {
    func reportErrorWith(exception: NSException) {
        guard let options = self.options,
              options.shouldInitInstrumentation(instrumentation: .errors) else { return }
    ...
    func logWith(severity: CoralogixLogSeverity,
        ...
        options.shouldInitInstrumentation(instrumentation: .lifeCycle) else { return }
