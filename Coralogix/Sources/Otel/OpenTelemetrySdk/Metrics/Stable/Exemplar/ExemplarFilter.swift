...
public struct AlwaysOnFilter : ExemplarFilter {
    public func shouldSampleMeasurement(value: Double, attributes: [String : AttributeValue]) -> Bool {
        return true
    }
    
    public func shouldSampleMeasurement(value: Int, attributes: [String : AttributeValue]) -> Bool {
        return true
    }
}
