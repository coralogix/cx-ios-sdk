...
public class ExemplarReservoir {
    ...
    public func offerDoubleMeasurement(value: Double, attributes: [String: AttributeValue]) {}
    
    public func offerLongMeasurement(value: Int, attributes: [String: AttributeValue]) {}
}
