...
swift_file="$script_dir/Coralogix-Internal/Sources/Utils.swift"
podspec_c_file="$script_dir/Coralogix.podspec"
podspec_ci_file="$script_dir/Coralogix-Internal.podspec"
podspec_sr_file="$script_dir/Session-Replay.podspec"
